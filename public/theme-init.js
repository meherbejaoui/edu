"use strict";
/* Manual light/dark/system theme toggle for edu (meherbejaoui.com/edu).
   ...
   other sub-sites, with edu's own localStorage key. */
(function () {
  var KEY = "edu-theme";
  ...
  window.__eduToggleTheme = function () {
  ...
  window.__eduCurrentTheme = current;
})();
